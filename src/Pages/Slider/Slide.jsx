        ...
        <div className='flex items-center justify-center w-full h-full bg-gray-900/70'>
          <div className='text-center space-y-5'>
            ...
            <p className="text-white lg:mx-80">The Luxury hotel hotel master is one of the best stylish hotels in madrid.This modern take on the traditional alpine lodge is located at the foot of the spain
             ...
             <button className='w-full px-5 py-4 mt-4 text-sm font-medium  capitalize transition-colors duration-300 transform bg-white  text-black rounded-md lg:w-auto hover:bg-gray-500 focus:outline-none focus:bg-gray-500'>
